...
// Dashboard Menu
$(".menu_dashboard a").click(function(){
  var option_dashboard = $(this).attr("value");
  console.log(option_dashboard);

  var account = $("#account_dashboard");
  var pet_info = $("#pet_info_dashboard");
  var donate = $("#donate_dashboard");
  var help = $("#help_dashboard");
  var open_chat = $("#open_chat_dashboard");
  var payments = $("#payments_dashboard");

  switch (option_dashboard) {
  	case 'account':
